module github.com/planetary-social/go-notification-service
...
require (
	...
	github.com/nbd-wtf/go-nostr v0.18.10 // indirect
	...
	github.com/ssbc/go-ssb v0.2.2-0.20230308230318-d6db27d1852d // indirect
